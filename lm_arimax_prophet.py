...
class LArmixProphet:
    ...
    def prophet_train(input_file: str,split_date: str) -> None:
        ...
        """
        df = LArmixProphet.parse_to_date_sales(pd.read_csv(input_file))

        LArmixProphet.dataframe_plot(df)

        train_series,test_series = LArmixProphet.split_df(split_date, df)
        ...
        LArmixProphet.calculate_mse_mae_mape("Prophet", test_series['Sales'], predicted_df['yhat'])
    ...
    def arima_train(input_file: str,split_date :str) -> None:
        ...
        LArmixProphet.calculate_mse_mae_mape("Arima", test_series['Sales'], predictions)
    ...
    def sarimax_train(input_file: str,split_date :str) -> None:
        ...
        LArmixProphet.calculate_mse_mae_mape("Sarimax", test_series['Sales'], predictions)
    ...
    def calculate_mse_mae_mape(model_name: str,expected_value,predictions) -> None:
        ...
        """
        mape = LArmixProphet.mean_absolute_percentage_error(expected_value, predictions)
...
def run():
    ...
    while True:
        LArmixProphet.print_menu()
        match int(input("User Input: ")):
            case 1:
                print("Now training Prophet...")
                LArmixProphet.prophet_train(input_file, split_date)
            case 2:
                print("Now training Arima...")
                LArmixProphet.arima_train(input_file, split_date)
            case 3:
                print("Now training Sarimax...")
                LArmixProphet.sarimax_train(input_file, split_date)
            case 4:
                print("Exitting...")
                break
            case _:
